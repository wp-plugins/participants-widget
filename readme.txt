...
1. Copy the themes/authors.php file into your theme directory you can also override the profile behavior 
(http://codex.wordpress.org/Author_Templates#Which_Template_File_is_Used.3F), and display a list of the 
